...
HR_rf_model <- randomForest(left~., data = breakDown::HR_data,
ntree = 100)
...
```{r limeWaterfallPlot, fig.cap='Waterfall plot created with live::plot_explanation'}
plot_explanation(trained, "waterfallplot", explained_instance = HR_data[1,])
```

... or *forest plot* ...

```{r limeForestPlot, fig.cap='Fotest plot created with live::plot_explanation'}
