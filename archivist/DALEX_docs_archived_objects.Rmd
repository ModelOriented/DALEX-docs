...
addHooksToPrint(class=c("broken", "data.frame", "explainer", "gbm", "ggplot", "knitr_kable", 
                        "lm", "model_performance_explainer", "randomForest", "summary.lm"),
                 repoDir = "arepo", 
                 repo = "DALEX_docs", user = "pbiecek", subdir = "archivist/arepo")
```
...
addHook <- function(object){
  ...
  hook <- asave(object, repoDir = "arepo", artifactName = name)
cat("Load ", name,": [`archivist::aread('pbiecek/DALEX_docs/archivist/arepo/", hook, "')`](https://raw.githubusercontent.com/pbiecek/DALEX_docs/master/archivist/arepo/gallery/", hook, ".rda)"," \n \n", sep = "")
}
```
