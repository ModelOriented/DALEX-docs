...
DALEX architecture is simple and consistent. Actually there are only tree rules that should be remembered and one is ready to use this tool.
...
To better understand how this function may be used next two sections introduce a use case for regression and binary classification.
...
knitr::kable(
  head(apartments),
  caption = 'Artificial dataset about apartments in Warsaw'
  )
```
