...
In this vignette we will show how `DALEX` can bu used for comparison of models across different languages.
...
Here the drop in `1 - AUC` is used to compare variable perforamnce.
