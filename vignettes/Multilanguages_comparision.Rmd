...
<span style="color:red">Please keep in mind, that [DALEXtra](https://CRAN.R-project.org/package=DALEXtra) now support usage of h2o with dedicated `explain_h2o` function and usage of scikit-learn models imported from Python with dedicated `explain_scikit` function. It is recommended to use them.</span> 
