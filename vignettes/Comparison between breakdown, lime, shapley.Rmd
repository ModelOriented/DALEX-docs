...
<span style="color:red">Please keep in mind, that `breakDown` package is archived and is no under development anymore. We suggests to use [iBreakDown](https://CRAN.R-project.org/package=iBreakDown) instead. In order to compute shapley values in R, You can use [shapper](https://CRAN.R-project.org/package=shapper) or also [iBreakDown](https://CRAN.R-project.org/package=iBreakDown).  </span> 
