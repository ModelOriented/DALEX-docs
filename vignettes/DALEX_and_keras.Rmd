...
<span style="color:red">Please keep in mind, that [DALEXtra](https://CRAN.R-project.org/package=DALEXtra) now support usage of keras models imported from Python with dedicated `explain_keras` function. It is recommended to use it.</span> 
