...
<span style="color:red">Please keep in mind, that [DALEXtra](https://CRAN.R-project.org/package=DALEXtra) now support usage of mlr with dedicated `explain_mlr` function. It is recommended to use it.</span> 
