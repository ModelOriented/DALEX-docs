...
explainer_regr_bt <- DALEX::explain(bt_fitted, data=titanic_r_test, y=titanic_r_test$fare, predict_function = custom_predict, label="bt")
...
predict_function = custom_predict, label="svm")
...
explainer_classif_rf <- DALEX::explain(rf_fitted, data=titanic_num_test, y=y_test, label= "rf", predict_function = custom_predict_classif)
...
explainer_classif_svm <- DALEX::explain(svm_fitted, data=titanic_num_test, y=y_test, label ="svm", predict_function = custom_predict_classif)
