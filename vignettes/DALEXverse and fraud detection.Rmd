...
```{r, echo=FALSE}
setwd('~/repo/')
load('fraud_serv/data/data_train_final')
load('fraud_serv/data/data_test_final')
col = ncol(data_train)
```
...
```{r modelling, message=FALSE, warning=FALSE, eval=FALSE}
...
load('fraud_serv/models/model_gbm')
load('fraud_serv/models/model_glmnet')
load('fraud_serv/models/model_rf')
```
...
```{r load_bd, echo=FALSE}
load('fraud_serv/plots/glm_bd')
load('fraud_serv/plots/gbm_bd')
load('fraud_serv/plots/rf_bd')
plotD3(glm_bd)
plotD3(rf_bd)
plotD3(gbm_bd)
```
...
```{r load_un, echo=FALSE}
load('fraud_serv/plots/glm_un')
load('fraud_serv/plots/gbm_un')
load('fraud_serv/plots/rf_un')
plot(glm_un)
plot(rf_un)
plot(gbm_un)
```
...
```{r load_pdp, echo=FALSE}
load('fraud_serv/plots/plots_pdp')
pdp_glm_V4 <- plots[[1]]
pdp_rf_V4 <- plots[[2]]
pdp_gbm_V4 <- plots[[3]]
